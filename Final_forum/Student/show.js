var firebaseConfig = {
  ...
  */
  ...
  function userClicked(e) {
	...
	const userRef = dbRef.child('question/' + userID);
	const userDetailUI = document.getElementById("userList");
  ...
  function readUserData() {
	  ...
	  usersRef.orderByChild("QuestionTitle").on("value", snap => {
		  ...
		  snap.forEach(childSnap => {
			  ...
			  $li.style.border="1px solid #FB8D77"
  ...
  function saveUserBtnClicked(e) {
	  ...
	  const userRef = dbRef.child('student/' + userID);
